...
def process_denoise_pair(wf_img, save_wf_path, path_size=224, stride=196):
...
def test_pre(data_root, task='denoise'):
    ...
    for region_index in os.listdir(data_root):
        ...
        for type in image_types:
            ...
            if task == 'denoise':
                process_denoise_pair(wf_file_img, save_wf_path, path_size=224, stride=196)
            else:
                process_denoise_pair(wf_file_img, save_wf_path, path_size=112, stride=98)
